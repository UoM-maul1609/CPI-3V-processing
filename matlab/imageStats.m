...
% CPI3V processing software to process data from the SPEC 3V-CPI
% Copyright (C) 2015  Paul Connolly
...
% To contact the author, email: p.connolly@manchester.ac.uk or by mail:
% Dr Paul Connolly, University of Manchester, Simon Building, Manchester, UK
%-------------------------------------------------------------------------------
warning off;
